...
$redirectUri = 'http://localhost/plugin/big_commerce_plugin/src/api/api.php?code=';
...
if (isset($_GET['code'])) {
    ...
    if (isset($data['access_token'])) {
        ...
        // Redirect to a different URL after OAuth2 authorization
...
$appMarkup = '<div>Your app content goes here.</div>';
